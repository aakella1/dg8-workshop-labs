...
public class Exercise3 {
        ...
        public static void main(String[] args) throws Exception {
                ...
                // TODO When each write-only operation completes, execute a read-only operation
                // to retrieve the value
                CompletableFuture<String> readFuture1 = writeFuture1
                                .thenCompose(r -> readOnlyMap.eval("key1", EntryView.ReadEntryView::get));
                CompletableFuture<String> readFuture2 = writeFuture2
                                .thenCompose(r -> readOnlyMap.eval("key2", EntryView.ReadEntryView::get));

                // TODO When the read-only operation completes, print it out
                System.out.printf("Created entries: %n");
                CompletableFuture<Void> end = readFuture1.thenAcceptBoth(readFuture2,
                                (v1, v2) -> System.out.printf("key1 = %s%nkey2 = %s%n", v1, v2));
                ...
                Traversable<EntryView.ReadEntryView<String, String>> entryViews = readOnlyMap.evalMany(data.keySet(),
